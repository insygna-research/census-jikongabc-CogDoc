...
# 验证 no valid docs passes without citation 场景。
...
# 验证 doc without page is ignored in registry 场景。
...
# 验证 valid half width citation 场景。
...
# 验证 valid full width citation 场景。
...
# 验证 valid lowercase p and spaces 场景。
...
# 验证 missing citation is rejected 场景。
...
# 验证 wrong source is rejected 场景。
...
# 验证 mixed valid and invalid still rejected 场景。
